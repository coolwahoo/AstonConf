...
const downloadSchedule = async () => {
       ...
       let response = await fetch("https://astonconf.azurewebsites.net/schedule/list");
...
const saveStar = async (sessionId, isStarred) => {
    ...
    const response = await fetch("http://astonconf.azurewebsites.net//schedule/star/" + sessionId, options);
